...
# CESAB <img src="man/figures/compendium-sticker.png" align="right" style="float:right; height:120px;"/>
...
- [`DESCRIPTION`](https://github.com/pole-emploi/CESAB/tree/main/DESCRIPTION):
  contains project metadata (authors, date, dependencies, etc.)

- [`make.R`](https://github.com/pole-emploi/CESAB/tree/main/make.R):
...
Launch the
[`make.R`](https://github.com/pole-emploi/CESAB/tree/main/make.R) file
with:
...
Guidelines](https://github.com/pole-emploi/CESAB/blob/main/CONTRIBUTING.md).
